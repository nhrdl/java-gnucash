...
jextract '@/tmp/gnucash.includes' --output "/tmp/src" -t net.raohome.gnucash.gen  `pkg-config --cflags glib-2.0` -I/usr/include/gnucash -l libgnc-engine -l libgnc-core-utils  --header-class-name GNUCashBinding /tmp/gnucash_files.h 
