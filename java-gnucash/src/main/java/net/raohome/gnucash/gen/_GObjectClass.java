...
public class _GObjectClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        GNUCashBinding.C_POINTER.withName("construct_properties"),
        GNUCashBinding.C_POINTER.withName("constructor"),
        GNUCashBinding.C_POINTER.withName("set_property"),
        GNUCashBinding.C_POINTER.withName("get_property"),
        GNUCashBinding.C_POINTER.withName("dispose"),
        GNUCashBinding.C_POINTER.withName("finalize"),
        GNUCashBinding.C_POINTER.withName("dispatch_properties_changed"),
        GNUCashBinding.C_POINTER.withName("notify"),
        GNUCashBinding.C_POINTER.withName("constructed"),
        GNUCashBinding.C_LONG.withName("flags"),
        GNUCashBinding.C_LONG.withName("n_construct_properties"),
        GNUCashBinding.C_POINTER.withName("pspecs"),
        GNUCashBinding.C_LONG.withName("n_pspecs"),
        MemoryLayout.sequenceLayout(3, GNUCashBinding.C_POINTER).withName("pdummy")
    ...
    public final static class constructor {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(constructor.Function.class, "apply", $DESC);
    ...
    public final static class set_property {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(set_property.Function.class, "apply", $DESC);
    ...
    public final static class get_property {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(get_property.Function.class, "apply", $DESC);
    ...
    public final static class dispose {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(dispose.Function.class, "apply", $DESC);
    ...
    public final static class finalize {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(finalize.Function.class, "apply", $DESC);
    ...
    public final static class dispatch_properties_changed {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(dispatch_properties_changed.Function.class, "apply", $DESC);
    ...
    public final static class notify {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(notify.Function.class, "apply", $DESC);
    ...
    public final static class constructed {
        ...
        private static final MethodHandle UP$MH = GNUCashBinding.upcallHandle(constructed.Function.class, "apply", $DESC);
